<?php 
    ...
    if($jumlah >= $qtyskrg){
        ...
        $updatedata1 = mysqli_query($conn,"update sbrg_keluar set tgl='$tanggal',jumlah='$jumlah',penerima='$penerima',ket_keluar='$keterangan' where id='$id'");
        ...
        if ($updatedata1 && $queryx){
            ...
            <meta http-equiv='refresh' content='3; url=/stock/keluar'> ";
            };
        ...
        $updatedata = mysqli_query($conn,"update sbrg_keluar set tgl='$tanggal', jumlah='$jumlah', penerima='$penerima', ket_keluar='$keterangan' where id='$id'");
