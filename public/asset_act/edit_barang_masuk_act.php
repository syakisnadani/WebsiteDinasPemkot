<?php 
    ...
    if($jumlah >= $qtyskrg){
        ...
        $queryx = mysqli_query($conn,"update asset_brg set stock='$tambahistock' where idx='$idx'");
        $updatedata1 = mysqli_query($conn,"update asset_masuk set tgl='$tanggal',jumlah='$jumlah',keterangan='$keterangan' where id='$id'");
        ...
        if ($updatedata1 && $queryx){
            ...
            <meta http-equiv='refresh' content='3; url=/asset/masuk'> ";
            };
        ...
        $query1 = mysqli_query($conn,"update asset_brg set stock='$kurangistock' where idx='$idx'");

        $updatedata = mysqli_query($conn,"update asset_masuk set tgl='$tanggal', jumlah='$jumlah', keterangan='$keterangan' where id='$id'");
