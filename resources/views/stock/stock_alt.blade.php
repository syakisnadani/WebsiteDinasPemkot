...
@php
    include 'stock_act/dbconnect.php';
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    ...
                                    <button style="margin-bottom:10px" data-toggle="modal" data-target="#modalFilter" class="btn btn-success"><i class="ti-settings"></i></button>
                                </div>
                                <div>
                                    <p align="right">
                                        <button style="margin-bottom:10px" data-toggle="modal" data-target="#modalStock" class="btn btn-info"><i class="ti-save"></i></button>
                                    </p>
                                    <p align="right">
                                        <button hidden style="margin-bottom:10px" data-toggle="modal" data-target="#modalInput" class="btn btn-info">Masukkan Barang</button>
                                    </p>
                                </div>
                                ...
                                <div class="market-status-table mt-4">
                                                ...
                                                <!-- The Modal -->
                                                    <div class="modal fade" id="edit{{ $idb }}">
                                                        ...
                                                        <form action="/stock_act/edit_stock_barang_act.php" method="post">
                                                            ...
                                                            <button type="button" class="btn btn-secondary" data-dismiss="modal"><i class="ti-close"></i></button>
                                                            <button type="submit" class="btn btn-success" name="update"><i class="ti-check"></i></button>
                                                            </div>
                                                            </form>
                                                        </div>
                                                        </div>
                                                    ...
                                                    <div class="modal fade" id="del{{ $idb }}">
                                                        ...
                                                        <form action="/stock_act/hapus_stock_barang_act.php" method="post">
                                                            ...
                                                            <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary" data-dismiss="modal"><i class="ti-close"></i></button>
                                                            <button type="submit" class="btn btn-danger" name="hapus"><i class="ti-check"></i></button>
                                                            </div>
                                                            </form>
                                                        </div>
                                                        </div>
                                    ...
                                    <button data-toggle="modal" data-target="#modalExport" class="btn btn-info"><i class="ti-export"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/stock_act/export_stock_barang.php" method="post">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal"><i class="ti-close"></i></button>
                            <button type="submit" class="btn btn-success" name="export"><i class="ti-check"></i></button>
                        </div>
                    </form>
                </div>
            </div>
                ...
                <div class="modal-body">
                    <form method="post">
                        ...
                        <div class="form-group" align="right">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal"><i class="ti-close"></i></button>
                            <button type="submit" name="submit" class="btn btn-success"><i class="ti-check"></i></button>
                            @method('GET')
                        </div>
                    </form>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal"><i class="ti-close"></i></button>
                        <button type="submit" class="btn btn-success" name="simpan"><i class="ti-check"></i></button>
                    </div>
                </form>
            </div>
        </div>
