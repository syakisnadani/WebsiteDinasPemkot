...
<title>{{ $header="Database" }} | {{ $title="Data File" }}</title>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div>
                                    <p align="right">
                                        <button hidden style="margin-bottom:10px" data-toggle="modal" data-target="#modalUpload" class="btn btn-info col-md-2">Tambah Data</button>
                                    </p>
                                    <p align="right">
                                        <button hidden style="margin-bottom:10px" data-toggle="modal" data-target="#modalUpload" class="btn btn-info col-md-2">Upload File</button>
                                    </p>
                                    <p align="right">
                                        <button style="margin-bottom:10px" data-toggle="modal" data-target="#modalUpload" class="btn btn-info col-md-2">Tambah Data</button>
                                    </p>
                                    <p align="right">
                                        <button hidden style="margin-bottom:10px" data-toggle="modal" data-target="#modalInput" class="btn btn-info col-md-2">Masukkan Data</button>
                                    </p>
                                </div>
                                    ...
                                    <div class="data-tables table-responsive datatable-custom">
                                         <table id="dataTable3" class="display" style="width:100%"><thead>
                                            ...
                                            @while($p=mysqli_fetch_array($data))
                                                ...
                                                @endphp
                                                @if (($p['department'] == Auth::user()->firstname || in_array($current_user, $admin_privilege)) && ($p['department'] == $filter_tipe || $filter_tipe == 'Semua'))
                                                ...
                                                <!-- The Modal -->
                                                        ...
                                                        <form action="/file_act/edit_files_act.php" method="post">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input required name="tahun" type="text" class="form-control" placeholder="Contohnya 2016-2019" value="{{ $p['keywords'] }}">
                                                                </div>
                                                                <div class="form-group">
                                                    ...
                                                    <div class="modal fade" id="del{{ $id_file }}">
                                                        ...
                                                        <form action="/file_act/delete_files_act.php" method="post">
                                                            <!-- Modal Header -->
                                                            <div class="modal-header">
                                                            <h4 class="modal-title">Hapus Item <br>{{ $p['title'] }}</h4>
                                                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    {{-- <form name="upload_form" enctype="multipart/form-data" action="upload_files_test.php" method="POST"> --}}
                        ...
                        <div class="form-group">
                            <label>Tahun Data</label>
                            <input required name="tahun" type="text" class="form-control" placeholder="Contohnya 2016-2019">
                        </div>
                        <div class="form-group">
                            <label>Keterangan</label>
