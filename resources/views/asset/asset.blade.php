...
@php
    ...
    $types=array("Alat","Laptop dan Notebook","Kendaraan Roda Dua dan Empat","Benda Elektronik","Lain-lain");
...
<body>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    <h2>
                                        @if ($filter_tipe == "Semua")
                                            Daftar Semua Jenis Asset
                                        @else
                                            Daftar Asset Jenis {{ $filter_tipe }}
                                        @endif
                                        <br>
                                ...
                                <div>
                                    ...
                                    <p align="right">
                                        <button hidden style="margin-bottom:10px" data-toggle="modal" data-target="#modalUpload" class="btn btn-info col-md-2">Upload Berita Acara</button>
                                    </p>
                                    <p align="right">
                                ...
                                <div class="market-status-table mt-4">
                                    <div class="data-tables table-responsive datatable-custom">
                                         <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
                                            ...
                                            @php
                                                $brgs=mysqli_query($conn,"SELECT * from asset_brg order by nama ASC");
                                                $no=1;
                                            @endphp
                                            @while($p=mysqli_fetch_array($brgs))
                                                ...
                                                <!-- The Modal -->
                                                    <div class="modal fade" id="edit{{ $idb }}">
                                                        ...
                                                        <form action="/asset_act/edit_stock_barang_act.php" method="post">
                                                            <!-- Modal Header -->
                                                            ...
                                                            <option value="Laptop dan Notebook">Laptop dan Notebook</option>
                                                            <option value="Kendaraan Roda Dua dan Empat">Kendaraan Roda Dua dan Empat</option>
                                                            <option value="Benda Elektronik">Benda Elektronik</option>
                                                    ...
                                                    <div class="modal fade" id="del{{ $idb }}">
                                                        <div class="modal-dialog">
                                                        <div class="modal-content">
                                                        <form action="/asset_act/hapus_stock_barang_act.php" method="post">
                                                            <!-- Modal Header -->
                                                            <div class="modal-header">
                                                            <h4 class="modal-title">Hapus Asset <br>{{ $p['nama'] }}-{{ $p['jenis'] }}-Rp. {{ $p['harga'] }}</h4>
                                                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                            </div>
                                                            
                                                            <!-- Modal body -->
                                                            <div class="modal-body">
                                                            Apakah Anda yakin ingin menghapus Asset ini dari daftar Asset?
                                                            <input type="hidden" name="idbrg" value="{{ $idb }}">
                                                            </div>
                ...
                <div class="modal-body">
                    ...
                    {{-- <form name="upload_form" enctype="multipart/form-data" action="upload_files_test.php" method="POST"> --}}
                        ...
                        <div class="form-group">
                            ...
                            <input disabled type="text" id="assigned_by" name="assigned_by" class="form-control" value="{{ Auth::user()->firstname }} {{ Auth::user()->lastname }}">
                        </div>
                        <div class="form-group">
                            <label>Keywords</label>
                            <input required name="keywords" type="text" class="form-control" placeholder="Keywords">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="modal-footer">
                            ...
                            <input type="hidden" name="assigned_by" value="{{ Auth::user()->role }}">
                            <button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
                            <input type="submit" class="btn btn-primary" name="upload" value="Upload">
                        </div>
                    </form>
                    <div hidden>
                        <form action="file_act/upload_files_act.php" method="post" enctype="multipart/form-data">
    ...
    <div id="modalExport" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/asset_act/export_stock_barang.php" method="post">
                        <div class="form-group">
    ...
    <div id="modalFilter" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Filter Asset</h4>
                </div>
                <div class="modal-body">
                    <form method="post">
                        <div class="form-group">
    ...
    <div id="modalInput" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Input Asset Masuk</h4>
                </div>
                <div class="modal-body">
                    <form action="/asset_act/tambah_barang_masuk_act.php" method="post">
                        <div class="form-group">
                            <label>Tanggal</label>
                            <input name="tanggal" type="date" class="form-control">
                        </div>
                        <div class="form-group">
                            ...
                            @php
                                $det=mysqli_query($conn,"select * from asset_brg order by nama ASC")or die(mysqli_error());
                            @endphp
    ...
    <div id="modalStock" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Masukkan asset manual</h4>
                </div>
                <div class="modal-body">
                    <form action="/asset_act/tambah_stock_barang_act.php" method="post">
                        <div class="form-group">
                            <label>Tanggal</label>
                            <input name="tanggal" type="date" class="form-control">
                        </div>
                        ...
                        <div hidden class="form-group">
                            ...
                            <input name="berita_acara" type="text" class="form-control" placeholder="Nomor Berita Acara">
                        </div>
                        <div class="form-group">
                            <label>Kode</label>
